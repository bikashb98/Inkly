        ...
        <div className="mx-6 px-6">
            <div className="flex justify-between items-center border-slate-300 border-b w-full px-10 py-4">
                ...
                <div className='flex items-center gap-8'>
                    <button className="group flex items-center gap-2 px-3 py-2 rounded transition-colors cursor-pointer">
                        <PencilSquareIcon className='w-6 h-6 text-slate-600 group-hover:text-slate-800 transition-colors' />
                        <span className="text-slate-600 font-medium group-hover:text-slate-800 transition-colors">Write</span>
                    </button>
                    <button >
                        <BellIcon className='w-6 h-6 text-slate-600 hover:text-slate-800 cursor-pointer'  />
                    </button>
